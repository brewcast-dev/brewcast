...
export default async function AdminUsersPage() {
  ...
  return (
    <main className="max-w-4xl mx-auto py-10 px-4 space-y-6">
      ...
      <div className="bg-obsidian border border-white/[0.06] rounded-xl overflow-hidden">
        <table className="w-full">
          <thead>
            <tr className="bg-onyx/50">
              <th className="text-left py-3 px-4 text-xs font-medium text-ash">Email</th>
              <th className="text-left py-3 px-4 text-xs font-medium text-ash">Brewery</th>
              <th className="text-left py-3 px-4 text-xs font-medium text-ash">Status</th>
              <th className="text-left py-3 px-4 text-xs font-medium text-ash">Role</th>
              <th className="text-left py-3 px-4 text-xs font-medium text-ash">Added</th>
          ...
          <tbody>
            {allowedUsers.length === 0 ? (
              <tr>
                <td colSpan={6} className="py-8 text-center text-ash text-sm">
      ...
      <div className="bg-obsidian border border-white/[0.06] rounded-xl p-5 space-y-2">
        ...
        <ol className="text-sm text-ash space-y-1 list-decimal list-inside">
          ...
          <li>Ask them to visit <span className="text-cream">/settings</span> and paste in their API keys.</li>
